...
(** Third, for abstractions, we have a choice:
    ...
    Coq, in its built-in functional programming language Gallina,
...
Inductive substi (s:tm) (x:id) : tm -> tm -> Prop :=
  ...
  | s_tabs2 :
      forall T t1 t1' y, x<>y -> substi s x t1 t1' -> substi s x (tabs y T t1) (tabs y T t1')
  | s_ttrue : substi s x ttrue ttrue
  | s_tfalse : substi s x tfalse tfalse
  | s_tif : forall t1 t2 t3 t1' t2' t3', substi s x t1 t1' -> substi s x t2 t2' -> substi s x t3 t3' -> substi s x (tif t1 t2 t3) (tif t1' t2' t3').
